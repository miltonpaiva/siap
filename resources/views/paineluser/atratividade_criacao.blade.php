                    ...
                    <div class="tab-pane fade show active" id="nav-section1" role="tabpanel" aria-labelledby="nav-section1-tab">
                      ...
                      <!-- <legend style="width:auto; margin-left:0; padding: 2px; font-size: 16px"> <strong class="text-info">ANÁLISE DE MERCADO</strong> </legend> -->
                        ...
                        <div class="form-group">
                          <textarea class="form-control" name="resposta1" id="resposta1" rows='11' placeholder='Máximo de caracteres 1.000.' maxlength="1000"></textarea>
                        ...
                        <div class="form-group">
                          <textarea class="form-control" name="resposta2" id="resposta2" rows='11' placeholder='Máximo de caracteres 1.000.' maxlength="1000"></textarea>
                        ...
                        <div class="form-group">
                          <textarea class="form-control" name="resposta3" id="resposta3" rows='11' placeholder='Máximo de caracteres 1.000.' maxlength="1000"></textarea>
                    ...
                    <div class="tab-pane fade" id="nav-section2" role="tabpanel" aria-labelledby="nav-section2-tab">
                      <fieldset id="section2" class="mt-3" style="padding: 10px">
                        <!-- <legend style="width:auto; margin-left:0; padding: 2px; font-size: 16px"> <strong class="text-info">ANÁLISE DE MERCADO</strong> </legend> -->
                          ...
                          <div class="form-group">
                            <textarea class="form-control" name="resposta4" id="resposta4" rows='11' placeholder='Máximo de caracteres 1.000.' maxlength="1000"></textarea>
                          ...
                          <div class="form-group">
                            <textarea class="form-control" name="resposta5" id="resposta5" rows='11' placeholder='Máximo de caracteres 1.000.' maxlength="1000"></textarea>
                          ...
                          <div class="form-group">
                            <textarea class="form-control" name="resposta6" id="resposta6" rows='11' placeholder='Máximo de caracteres 1.000.' maxlength="1000"></textarea>
                          ...
                          <div class="form-group">
                            <textarea class="form-control" name="resposta7" id="resposta7" rows='11' placeholder='Máximo de caracteres 1.000.' maxlength="1000"></textarea>
                    ...
                    <div class="tab-pane fade" id="nav-section3" role="tabpanel" aria-labelledby="nav-section3-tab">
                      <fieldset id="section3" class="mt-3" style="padding: 10px">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="linkVideo" onchange="fileLink()" aria-describedby="linkVideolHelp" placeholder="Ex.: https://www.youtube.com/watch?v=MQs_MGaXqhk">
                        ...
                        <div class="form-group">
                          ...
                          <div class="custom-file">
                              <input type="file" class="custom-file-input imput_slide" onchange="fileSlide()" id="slide" accept="application/pdf">
                      ...
                      <div class="tab-pane fade" id="nav-section4" role="tabpanel" aria-labelledby="nav-section4-tab">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input imput_certificados" onchange="certificadoSlide()" id="certificados" accept="image/gif, image/jpeg, image/png, application/pdf">
