        ...
        <div class="card-body">
              ...
              <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  <a class="nav-item nav-link active" id="nav-section0-tab" data-toggle="tab" href="#nav-section0" role="tab" aria-controls="nav-section6" aria-selected="true">Revisão das Informações</a>
                    ...
                    <div class="tab-pane fade" id="nav-section1" role="tabpanel" aria-labelledby="nav-section1-tab">
                      ...
                      <!-- <legend style="width:auto; margin-left:0; padding: 2px; font-size: 16px"> <strong class="text-info">ANÁLISE DE MERCADO</strong> </legend> -->
                        ...
                        <div class="form-group">
                          ...
                          @endif
                          <textarea class="form-control text_resp obrigatorio" session="nav-section1" name="resposta[11]" criterea="11" id="resposta1" rows='11' placeholder='Máximo de caracteres 1.000.' maxlength="1000">{{@$attrs[11]['response']}}</textarea>
                        ...
                        <div class="form-group">
                          ...
                          @endif
                          <textarea class="form-control text_resp obrigatorio" session="nav-section1" name="resposta[12]" criterea="12" id="resposta2" rows='11' placeholder='Máximo de caracteres 1.000.' maxlength="1000">{{@$attrs[12]['response']}}</textarea>
                        ...
                        <div class="form-group">
                          ...
                          @endif
                          <textarea class="form-control text_resp obrigatorio" session="nav-section1" name="resposta[13]" criterea="13" id="resposta3" rows='11' placeholder='Máximo de caracteres 1.000.' maxlength="1000">{{@$attrs[13]['response']}}</textarea>
                      ...
                      <fieldset id="section2" class="mt-3" style="padding: 10px">
                        <!-- <legend style="width:auto; margin-left:0; padding: 2px; font-size: 16px"> <strong class="text-info">ANÁLISE DE MERCADO</strong> </legend> -->
                          ...
                          <div class="form-group">
                            ...
                            @endif
                            <textarea class="form-control text_resp obrigatorio" session="nav-section2" name="resposta[14]" criterea="14" id="resposta4" rows='11' placeholder='Máximo de caracteres 1.000.' maxlength="1000">{{@$attrs[14]['response']}}</textarea>
                          ...
                          <div class="form-group">
                            ...
                            @endif
                            <textarea class="form-control text_resp obrigatorio" session="nav-section2" name="resposta[15]" criterea="15" id="resposta5" rows='11' placeholder='Máximo de caracteres 1.000.' maxlength="1000">{{@$attrs[15]['response']}}</textarea>
                          ...
                          <div class="form-group">
                            ...
                            @endif
                            <textarea class="form-control text_resp obrigatorio" session="nav-section2" name="resposta[16]" criterea="16" id="resposta6" rows='11' placeholder='Máximo de caracteres 1.000.' maxlength="1000">{{@$attrs[16]['response']}}</textarea>
                          ...
                          <div class="form-group">
                            ...
                            @endif
                            <textarea class="form-control text_resp obrigatorio" session="nav-section2" name="resposta[17]" criterea="17" id="resposta7" rows='11' placeholder='Máximo de caracteres 1.000.' maxlength="1000">{{@$attrs[17]['response']}}</textarea>
                    ...
                    <div class="tab-pane fade" id="nav-section3" role="tabpanel" aria-labelledby="nav-section3-tab">
                      <fieldset id="section3" class="mt-3" style="padding: 10px">
                        ...
                        <div class="form-group">
                          ...
                          @endif
                          <input type="text" class="form-control text_resp" id="linkVideo" session="nav-section3" name="resposta[10]" criterea="10" onchange="fileLink()" aria-describedby="linkVideolHelp" placeholder="Ex.: https://www.youtube.com/watch?v=MQs_MGaXqhk" value="{{@$attrs[10]['response']}}" >
                        ...
                        <div class="form-group">
                          ...
                          <div class="custom-file">
                              <input type="file" class="custom-file-input imput_slide text_resp obrigatorio " session="nav-section3" onchange="fileSlide()" id="slide" name="files[slide]" session="nav-section3" accept="application/pdf">
